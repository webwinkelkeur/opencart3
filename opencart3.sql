...
--
-- Host: 172.18.0.2    Database: wwk_oc3
-- ------------------------------------------------------
-- Server version	5.5.5-10.1.35-MariaDB-1
...
--
-- ORDER BY:  `advertise_google_target_id`
...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2019-01-30 10:29:55','2019-01-30 10:29:55');
...
--
-- ORDER BY:  `attribute_id`,`language_id`
...
--
-- ORDER BY:  `attribute_group_id`,`language_id`
...
--
-- ORDER BY:  `category_id`,`filter_id`
...
--
-- ORDER BY:  `google_product_category`,`store_id`
...
--
-- ORDER BY:  `coupon_id`,`category_id`
...
INSERT INTO `oc_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.61250001,1,'2014-09-25 14:40:00'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2019-01-30 10:31:27'),(3,'Euro','EUR','','€','2',0.78460002,1,'2014-09-25 14:40:00');
...
--
-- ORDER BY:  `custom_field_id`,`customer_group_id`
...
--
-- ORDER BY:  `custom_field_id`,`language_id`
...
--
-- ORDER BY:  `custom_field_value_id`
...
--
-- ORDER BY:  `custom_field_value_id`,`language_id`
...
--
-- ORDER BY:  `customer_group_id`,`language_id`
...
--
-- ORDER BY:  `download_id`,`language_id`
...
--
-- ORDER BY:  `filter_id`,`language_id`
...
--
-- ORDER BY:  `filter_group_id`,`language_id`
...
--
-- ORDER BY:  `information_id`,`language_id`
...
--
-- ORDER BY:  `information_id`,`store_id`
...
--
-- ORDER BY:  `length_class_id`,`language_id`
...
--
-- ORDER BY:  `manufacturer_id`,`store_id`
...
--
-- ORDER BY:  `option_id`,`language_id`
...
--
-- ORDER BY:  `option_value_id`,`language_id`
...
--
-- ORDER BY:  `order_recurring_transaction_id`
...
--
-- ORDER BY:  `order_status_id`,`language_id`
...
--
-- ORDER BY:  `product_advertise_google_id`
...
--
-- ORDER BY:  `product_id`,`store_id`,`product_variation_id`
...
--
-- ORDER BY:  `product_id`,`advertise_google_target_id`
...
--
-- ORDER BY:  `product_option_value_id`
...
--
-- ORDER BY:  `product_id`,`recurring_id`,`customer_group_id`
...
--
-- ORDER BY:  `recurring_id`,`language_id`
...
--
-- ORDER BY:  `return_action_id`,`language_id`
...
--
-- ORDER BY:  `return_reason_id`,`language_id`
...
--
-- ORDER BY:  `return_status_id`,`language_id`
...
INSERT INTO `oc_session` VALUES ('9087995f46d594c4bd509d4fe3','{\"user_id\":\"1\",\"user_token\":\"zOEjXJBdjZjdEE9PfRIC9VDXvCjZqJX5\"}','2019-01-30 10:55:27');
...
--
-- ORDER BY:  `stock_status_id`,`language_id`
...
--
-- ORDER BY:  `tax_rate_id`,`customer_group_id`
...
INSERT INTO `oc_user` VALUES (1,1,'admin','57d8dba098903412ae036d852c78d5a9558454b4','3LWUaxt4w','John','Doe','albert@peschar.net','','','172.18.0.1',1,'2019-01-30 10:29:55');
...
--
-- ORDER BY:  `voucher_theme_id`,`language_id`
...
--
-- ORDER BY:  `weight_class_id`,`language_id`
...
-- Dump completed on 2019-01-30 12:32:08
